      ...
      Array<
        Maybe<
          ...
          > & {
              node?: Maybe<
                | { __typename?: "App" }
                | ({ __typename?: "Issue" } & Pick<Issue, "title">)
                | { __typename?: "MarketplaceListing" }
                | { __typename?: "Organization" }
                | { __typename?: "PullRequest" }
                | { __typename?: "Repository" }
...
export function useGetIssuesQuery(
  ...
  return Apollo.useQuery<GetIssuesQuery, GetIssuesQueryVariables>(
    GetIssuesDocument,
    baseOptions
  );
}
export function useGetIssuesLazyQuery(
  ...
  return Apollo.useLazyQuery<GetIssuesQuery, GetIssuesQueryVariables>(
    GetIssuesDocument,
    baseOptions
  );
}
...
>;
export type GetIssuesQueryResult = Apollo.QueryResult<
  GetIssuesQuery,
  GetIssuesQueryVariables
>;
